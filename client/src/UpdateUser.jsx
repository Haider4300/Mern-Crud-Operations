...
function UpdateUser() {
  ...
  return (
    <div style={{ backgroundColor: "blue", minHeight: "100vh" }} className="d-flex justify-content-center align-items-center">
    <div className="w-50 bg-white rounded p-3">
      <form className="text-start" onSubmit={Update}>
      <h2 className="text-start">Add Users</h2>
        <div className="mb-2">
